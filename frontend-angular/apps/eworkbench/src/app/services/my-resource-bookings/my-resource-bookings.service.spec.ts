...
import { of } from 'rxjs';
import { MyResourceBookingsService } from './my-resource-bookings.service';

const pk = '185cdf73-57d3-442e-b778-7ccba9a54b4e';

describe('MyResourceBookingsService', () => {
  let spectator: SpectatorHttp<MyResourceBookingsService>;
  const createService = createHttpFactory({
    service: MyResourceBookingsService,
    providers: [
      mockProvider(MyResourceBookingsService, {
