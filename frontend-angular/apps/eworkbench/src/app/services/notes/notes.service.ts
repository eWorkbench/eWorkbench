...
export class NotesService
  ...
  public getList(params?: HttpParams): Observable<{ total: number; data: Note[] }> {
    return this.httpClient
      .get<DjangoAPI<Note[]>>(this.apiUrl, { params })
      .pipe(
        map(
  ...
  public add(note: NotePayload, params?: HttpParams): Observable<Note> {
    return this.httpClient.post<Note>(this.apiUrl, note, { params });
  }

  public get(id: string, userId: number, params?: HttpParams): Observable<PrivilegesData<Note>> {
    return this.httpClient
      .get<Note>(`${this.apiUrl}${id}/`, { params })
      .pipe(
        switchMap(
  ...
  public delete(id: string, params?: HttpParams): Observable<Note> {
    return this.httpClient.patch<Note>(`${this.apiUrl}${id}/soft_delete/`, { pk: id }, { params });
  }

  public patch(id: string, note: NotePayload, params?: HttpParams): Observable<Note> {
    return this.httpClient.patch<Note>(`${this.apiUrl}${id}/`, note, { params });
  }

  public restore(id: string, params?: HttpParams): Observable<Note> {
