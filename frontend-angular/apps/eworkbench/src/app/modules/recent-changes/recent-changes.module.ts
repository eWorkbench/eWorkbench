...
import { RecentChangesResourceUsageSettingUserGroupsComponent } from './components/recent-changes/resource-usage-setting-user-groups/user-groups.component';
...
@NgModule({
  declarations: [
    ...
    RecentChangesResourceUsageSettingUserGroupsComponent,
