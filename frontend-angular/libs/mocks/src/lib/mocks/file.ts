...
import type { File } from '@eworkbench/types';
...
export const mockFile: File = {
  ...
  description: '',
  file_size: 69554,
  url: 'http://localhost:8000/api/files/fff1d25f-f41c-42e0-93fb-bfb83c3411a5/',
  container_id: null,
  ...
  is_dss_file: false,
  download: 'http://localhost:8000/api/files/1128c316-d046-4a8a-9553-2c0e70f6927d/download/',
  envelope_id: null,
  display: 'ccitt_4.tif',
