...
export const mockPluginDetails: PluginDetails = {
  ...
  url: 'http://localhost:8000/api/plugins/f76b6f87-1076-4ce8-8150-3ac928118845/',
  ...
  logo: 'http://localhost:8000/static/uploaded_media/unknown_plugin.gif',
  download_placeholder_picture:
    'http://localhost:8000/api/plugins/f76b6f87-1076-4ce8-8150-3ac928118845/picture.png/?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwYXRoIjoiL2FwaS9wbHVnaW5zL2Y3NmI2Zjg3LTEwNzYtNGNlOC04MTUwLTNhYzkyODExODg0NS9waWN0dXJlLnBuZy8iLCJ1c2VyIjoxNTAsImp3dF92ZXJpZmljYXRpb25fdG9rZW4iOiIzYzEyM2JmMjNjNjM0MTQwOWMxMTUyYWQ3MWRmNTA0MSIsImV4cCI6MTYxMTI0NDM1M30.vMxpJvVexw4tFz8cEjlF1OSchQXXtyogdrg2FXGqLBU',
  is_accessible: true,
  iframe_height: 500,
};
...
export const mockPluginInstance: PluginInstance = {
  ...
  metadata: [],
  title: 'Title',
  url: 'http://localhost:8000/api/plugininstances/d0729647-f8b9-4ebc-b91a-6593d6b06611/',
  deleted: false,
  created_by: mockUser,
...
export const mockPluginInstanceVersion: any = {
  ...
  title: 'Title 123!',
  url: 'http://localhost:8000/api/plugininstances/f1513975-6651-4dd0-afc7-d279123a1662/',
  deleted: false,
  created_by: mockUser,
  download_picture: null,
  plugin_details: mockPluginDetails,
