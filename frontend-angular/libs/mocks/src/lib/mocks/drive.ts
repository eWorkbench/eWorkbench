...
import type { Drive } from '@eworkbench/types';
...
export const mockDrive: Drive = {
  ...
  is_dss_drive: false,
  metadata: [],
  webdav_url: 'http://localhost:8000/webdav/d/MyStorage%20(a95db858-e215-4d0d-a83d-857d565b53d6)/',
  location: '',
  sub_directories_url: 'http://localhost:8000/api/drives/a95db858-e215-4d0d-a83d-857d565b53d6/sub_directories/',
  deleted: false,
  ...
  imported: false,
  container_id: null,
  url: 'http://localhost:8000/api/drives/a95db858-e215-4d0d-a83d-857d565b53d6/',
  title: 'MyStorage',
