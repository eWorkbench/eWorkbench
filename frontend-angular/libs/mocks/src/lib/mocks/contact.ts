...
import type { Contact, ContactPayload, DjangoAPI, RecentChanges, Version } from '@eworkbench/types';
...
export const mockContact: Contact = {
  ...
  url: 'http://localhost:8000/api/contacts/17200f04-e862-4a67-938c-86739403984e/',
  version_number: 64,
  is_favourite: false,
};
