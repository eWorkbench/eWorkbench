...
import type { DjangoAPI, DMP, DMPForm, DMPFormData, DMPPayload, RecentChanges, Version } from '@eworkbench/types';
...
export const mockDMPFormData: DMPFormData = {
  ...
  url: 'http://localhost:8000/api/dmps/fa70ff87-910b-4782-91a2-d11ae9cdc7ac/data/f93040d3-5f92-48cd-a1f9-c6d718c335ba/',
...
export const mockDMP: DMP = {
  ...
  status: 'PROG',
  created_by: mockUser,
  url: 'http://localhost:8000/api/dmps/fa70ff87-910b-4782-91a2-d11ae9cdc7ac/',
...
export const mockDMPVersion: Version = {
  ...
  status: 'NEW',
  created_by: mockUser,
  url: 'http://localhost:8000/api/dmps/ed1f4f29-655e-4791-9d80-41bf801ee39d/',
  last_modified_by: mockUser,
  display: 'Test DMP',
  dmp_form: '802eb7fa-49f4-443a-8e2f-f17e20979ef3',
};
