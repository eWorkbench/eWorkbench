...
(function () {
    ...
    module.controller('ResourceViewController', function (
        ...
        vm.saveChanges = function () {
            ...
            ResourceRestService.update(vm.resource).$promise.then(
                function (response) {
                    toaster.pop('success', "Resource updated");
                    vm.switchToView();
                },
        ...
        /**
         * Watcher for emit signal from child widget (resource booking rules)
         */
        $scope.$on('saveResourceBookingRules', function (event, data) {
