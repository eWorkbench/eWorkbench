                    ...
                    $.each(this.split(','), function (j, buttonName) {
                        ...
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                //define correct css classes for buttons
                                ...
                                classes = [
                                    'btn', btnClass, 'btn-' + buttonName + '-button',
                                ];

                                // overrides the button schedules so that a anchor tag with the correct url is generated
                                if (buttonName == 'schedule') {
                                    button = $( // type="button" so that it doesn't submit a form
                                        '<h1 style="margin-top: 0px;">' +
                                        '<a class="my-schedule-title" href="' + options.href + '" role="button">' +
                                        innerHtml +
                                        '</a></h1>'
                                    )
                                } else {
