...
(function () {
    ...
    module.directive('taskChecklistItemDiffWidget', function () {
        return {
            restrict: 'E',
            controller: 'TaskChecklistItemDiffWidgetController',
            templateUrl: 'js/widgets/taskChecklistItemDiffWidget/taskChecklistItemDiffWidget.html',
            scope: {
                leftObjStr: '@',
                rightObjStr: '@'
            },
    ...
    module.controller('TaskChecklistItemDiffWidgetController', function (
        $scope
    ) {
        var vm = this;
                ...
                vm.leftObj, vm.rightObj, {
                    comparator: function (left, right) {
                        ...
                        if (right.pk === left.pk && right.fields.title === left.fields.title
                            && right.fields.checked === left.fields.checked) {
