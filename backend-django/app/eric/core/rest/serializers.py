...
class HyperlinkedToListField(relations.HyperlinkedIdentityField):
    ...
    def to_representation(self, obj):
        ...
        return reverse(self.view_name, kwargs={self.lookup_field_name: obj.pk}, request=request)
...
class HyperlinkedQueryToListField(relations.HyperlinkedIdentityField):
    ...
    def to_representation(self, obj):
        ...
        return "{}?{}".format(
            reverse(self.view_name, request=request), urllib.parse.urlencode({self.lookup_field_name: obj.pk})
        )
