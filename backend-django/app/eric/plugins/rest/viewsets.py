...
from eric.plugins.rest.filters import PluginFilter, PluginInstanceFilter
from eric.plugins.rest.permissions import HasPluginAccess
from eric.plugins.rest.serializers import PluginFeedbackSerializer, PluginInstanceSerializer, PluginSerializer
...
class PluginViewSet(
    ...
    def get_queryset(self):
        ...
        try:
            ...
            only_plugins_with_access = util.strtobool(self.request.GET["onlyPluginsWithAccess"])
    ...
    @action(detail=True, methods=["GET"], url_path="picture.png", url_name="placeholder-picture")
    ...
    def create_and_send_mail(context, type):
        ...
        msg = EmailMultiAlternatives(
            subject=_(
                "{title} Plugins: {subject} ".format(title=site_preferences.site_name, subject=context["subject"])
            ),
    ...
    def feedback(self, request, *args, **kwargs):
        ...
        plugin_admin_url = request.build_absolute_uri(reverse("admin:plugins_plugin_change", args=(plugin.pk,)))
...
class PluginInstanceViewSet(
    ...
    @action(detail=True, methods=["GET"], url_path="rawdata", url_name="rawdata")
    ...
    @action(detail=True, methods=["GET"], url_path="picture.png", url_name="picture")
