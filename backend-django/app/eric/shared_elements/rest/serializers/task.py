...
from eric.core.rest.serializers import BaseModelSerializer, BaseModelWithCreatedBySerializer, \
    BaseModelWithCreatedByAndSoftDeleteSerializer, PublicUserSerializer
...
class MinimalisticTaskSerializer(BaseModelWithCreatedBySerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'assigned_users', 'created_by', 'created_at', 'last_modified_by', 'last_modified_at'
        )
...
class TaskSerializer(BaseModelWithCreatedByAndSoftDeleteSerializer, EntityMetadataSerializerMixin):
    ...
    projects = ProjectPrimaryKeyRelatedField(
        many=True,
        required=False
    )

    labels = ElementLabelPrimaryKeyRelatedField(
        many=True,
        required=False
    )
