...
class UserAttendsMeetingMixin:
    ...
    def update_attending_users(self, auth_token, meeting_id, user_id_list, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        data = {
            'attending_users_pk': user_id_list
        }
...
class FileMixin(TestLockMixin):
    ...
    def rest_get_file_export_link(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/files/{}/get_export_link/'.format(task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_search_files(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/files/?search={}'.format(search_string),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_files_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/files/?recently_modified_by_me={}'.format(number_of_days),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_download_file(self, auth_token, uploaded_file_entry_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/files/{}/download/'.format(uploaded_file_entry_pk),
            {},
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_file(self, auth_token, file_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            '/api/files/{pk}/'.format(pk=file_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_file(self, auth_token, file_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/files/{pk}/restore/'.format(pk=file_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_trash_file(self, auth_token, file_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/files/{pk}/soft_delete/'.format(pk=file_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )

    def rest_update_file(self, auth_token, file_pk, project_pks, file_title, file_description, file_name, file_size,
        ...
        return self.client.put(
            '/api/files/{}/'.format(file_pk),
            data, format='multipart',  # needs to be multi part for file uploads
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_duplicate_file(self, auth_token, project_pks, file_title, file_description, file_to_duplicate_pk,
                            HTTP_USER_AGENT, REMOTE_ADDR):
    ...
    def rest_create_file(self, auth_token, project_pks,
    ...
    def create_file_orm(self, auth_token, project_pk,
                        title, description, file_name, file_size,
                        HTTP_USER_AGENT, REMOTE_ADDR):
        """ Wrapper for rest_create_file which also returns a File Object from Djangos ORM """

        response = self.rest_create_file(auth_token, project_pk,
                                         title, description, file_name, file_size,
                                         HTTP_USER_AGENT, REMOTE_ADDR)
...
class NoteMixin(TestLockMixin):
    ...
    def rest_get_note_export_link(self, auth_token, note_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/notes/{}/get_export_link/'.format(note_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_search_notes(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/notes/?search={}'.format(search_string),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_notes_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/notes/?recently_modified_by_me={}'.format(number_of_days),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_note(self, auth_token, note_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            '/api/notes/{pk}/'.format(pk=note_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_note(self, auth_token, note_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/notes/{pk}/restore/'.format(pk=note_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_trash_note(self, auth_token, note_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/notes/{pk}/soft_delete/'.format(pk=note_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_create_note(self, auth_token, project_pks,
                         subject, content,
                         HTTP_USER_AGENT, REMOTE_ADDR):
        """ Wrapper for creating a file via REST API """
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + auth_token)
    ...
    def create_note_orm(self, auth_token, project_pk,
                        subject, content,
                        HTTP_USER_AGENT, REMOTE_ADDR):
        """ Wrapper for rest_create_note which also returns a Task Object from Djangos ORM """

        response = self.rest_create_note(auth_token, project_pk,
                                         subject, content,
                                         HTTP_USER_AGENT, REMOTE_ADDR)
        if response.status_code == status.HTTP_201_CREATED:
            decoded = json.loads(response.content.decode())
...
class TaskMixin(TestLockMixin):
    ...
    def rest_get_task_export_link(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/tasks/{}/get_export_link/'.format(task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_search_tasks(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/tasks/?search={}'.format(search_string),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_tasks_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/tasks/?recently_modified_by_me={}'.format(number_of_days),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_task(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            '/api/tasks/{pk}/'.format(pk=task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_task(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/tasks/{pk}/restore/'.format(pk=task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_trash_task(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/tasks/{pk}/soft_delete/'.format(pk=task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_update_task(self, auth_token, task_pk, project_pks, title, description, state, priority, start_date,
                         due_date, assigned_user, HTTP_USER_AGENT, REMOTE_ADDR):
    ...
    def rest_update_task_assigned_users(self, auth_token, task_pk, assigned_users, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        data = {
            'assigned_users_pk': assigned_users
        }
    ...
    def create_task_orm(self, auth_token, project_pk,
                        title, description, state, priority, start_date, due_date, assigned_user,
                        HTTP_USER_AGENT, REMOTE_ADDR):
        """ Wrapper for rest_create_task which also returns a Task Object from Djangos ORM """

        response = self.rest_create_task(auth_token, project_pk,
                                         title, description, state, priority, start_date, due_date, assigned_user,
                                         HTTP_USER_AGENT, REMOTE_ADDR)
        if response.status_code == status.HTTP_201_CREATED:
            decoded = json.loads(response.content.decode())
...
class ContactMixin(TestLockMixin):
    ...
    def rest_get_contact_export_link(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/contacts/{}/get_export_link/'.format(task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_search_contacts(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/contacts/?search={}'.format(search_string),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_contacts_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/contacts/?recently_modified_by_me={}'.format(number_of_days),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_contact(self, auth_token, contact_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/contacts/{}/'.format(contact_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_create_contact(self, auth_token, project_pks, academic_title, firstname, lastname, email,
                            HTTP_USER_AGENT, REMOTE_ADDR, company='', phone=''):
        """
    ...
    def rest_delete_contact(self, auth_token, contact_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            '/api/contacts/{pk}/'.format(pk=contact_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_contact(self, auth_token, contact_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/contacts/{pk}/restore/'.format(pk=contact_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_trash_contact(self, auth_token, contact_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/contacts/{pk}/soft_delete/'.format(pk=contact_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )

    def rest_update_contact(self, auth_token, contact_id, project_pks, academic_title, firstname, lastname, email,
                            HTTP_USER_AGENT, REMOTE_ADDR, company='', phone=''):
        """
        ...
        response = self.client.put(
            '/api/contacts/{}/'.format(contact_id),
            json.dumps(data, default=custom_json_handler),
            content_type='application/json',
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def create_contact_orm(self, auth_token, project_pk,
                           academic_title,
                           first_name, last_name, email,
                           HTTP_USER_AGENT, REMOTE_ADDR, company='', phone=''):
        """ Wrapper for rest_create_contact which also returns a Contact Object from Djangos ORM """

        response = self.rest_create_contact(auth_token, project_pk, academic_title, first_name, last_name, email,
                                            HTTP_USER_AGENT, REMOTE_ADDR,
...
class MeetingMixin(TestLockMixin):
    ...
    def rest_get_meeting_export_link(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/meetings/{}/get_export_link/'.format(task_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_search_meetings(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/meetings/?search={}'.format(search_string),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_meetings_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/meetings/?recently_modified_by_me={}'.format(number_of_days),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_create_meeting(self, auth_token, project_pks, title, description, start_date, end_date,
                            HTTP_USER_AGENT, REMOTE_ADDR, attending_users=None, attending_contacts=None):
        """
    ...
    def rest_update_meeting_attending_users(self, auth_token, meeting_pk, attending_users, HTTP_USER_AGENT,
                                            REMOTE_ADDR):
        """
        ...
        data = {
            'attending_users_pk': attending_users
        }
    ...
    def rest_delete_meeting(self, auth_token, meeting_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            '/api/meetings/{pk}/'.format(pk=meeting_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_meeting(self, auth_token, meeting_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/meetings/{pk}/restore/'.format(pk=meeting_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_trash_meeting(self, auth_token, meeting_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            '/api/meetings/{pk}/soft_delete/'.format(pk=meeting_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )

    def rest_update_meeting(self, auth_token, meeting_id, project_pks, title, description, start_date, end_date,
                            HTTP_USER_AGENT, REMOTE_ADDR):
        """
    ...
    def create_meeting_orm(self, auth_token, project_pk,
        ...
        response = self.rest_create_meeting(auth_token, project_pk,
                                            title, description, start_date, end_date,
                                            HTTP_USER_AGENT, REMOTE_ADDR, attending_users, attending_contacts)
        if response.status_code == status.HTTP_201_CREATED:
            decoded = json.loads(response.content.decode())
...
class ResourceBookingMixin(TestLockMixin):
    ...
    def rest_get_resourcebooking_export_link(self, auth_token, meeting_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        """
        ...
        return self.client.get(
            '/api/meetings/{}/get_export_link/'.format(meeting_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_resourcebooking(self, auth_token, resourcebooking_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            '/api/meetings/{}/'.format(resourcebooking_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_resourcebooking(self, auth_token, resourcebooking_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            '/api/meetings/{pk}/'.format(pk=resourcebooking_pk),
            HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
