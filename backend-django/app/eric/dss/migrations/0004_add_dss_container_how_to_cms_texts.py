...
<p>There must not be slashes at the beginning or the end of the path, so it should look something like this: <strong><em>dssfs01/pr53ve/pr53ve-dss-0000</em></strong></p>
...
<ol>
	...
	<pre>
[
    {<span style="color:#e74c3c">&quot;path&quot;</span>:<span style="color:#16a085"> &quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-1/storage-1/example-1-1-1.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>: <span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-1/storage-1/example-1-1-2.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>:<span style="color:#16a085"> &quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-1/storage-1/subdir-1/example-1-1.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>:<span style="color:#16a085"> &quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-2/storage-2/subdir-2/subdir-3/example-2-2.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>: <span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-3/storage-3/example-3-1.txt&quot;</span>}
]
</pre>
	</li>
...
[
    {<span style="color:#e74c3c">&quot;path&quot;</span>: <span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-1/storage-1/example-1-1-1.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>:<span style="color:#89ca78"> </span><span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-1/storage-1/example-1-1-2.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>:<span style="color:#89ca78"> </span><span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-1/storage-1/subdir-1/example-1-1.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>: <span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-2/storage-2/subdir-2/subdir-3/example-2-2.txt&quot;</span>},
    {<span style="color:#e74c3c">&quot;path&quot;</span>:<span style="color:#89ca78"> </span><span style="color:#16a085">&quot;/dss/dssfs01/pr53ve/pr53ve-dss-0000/envelope-3/storage-3/example-3-1.txt&quot;</span>}
]</pre>
"""
...
<p>Workbench storages and files that are within a DSS container will have extra metadata fields. Both have a read-only <em>DSS Location</em> field, that looks something like this: <em>DSS: dssfs01/pr53ve/pr53ve-dss-0000</em></p>
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dss', '0003_edit_verbose_names'),
    ]

    operations = [
        migrations.RunPython(create_dss_how_to_texts, remove_dss_how_to_texts),
    ]
