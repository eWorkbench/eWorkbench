...
class PictureMixin(TestLockMixin):
    ...
    def rest_get_picture_export_link(self, auth_token, picture_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/pictures/{picture_pk}/get_export_link/",
    ...
    def rest_search_pictures(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/pictures/?search={search_string}", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_pictures_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/pictures/?recently_modified_by_me={number_of_days}",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_picture(self, auth_token, picture_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(f"/api/pictures/{picture_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_pictures(self, auth_token, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get("/api/pictures/", {}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_pictures_for_project(self, auth_token, project_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            "/api/pictures/", {"project": project_pk}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_picture(self, auth_token, picture_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            f"/api/pictures/{picture_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_picture(self, auth_token, picture_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/pictures/{picture_pk}/restore/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_trash_picture(self, auth_token, picture_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/pictures/{picture_pk}/soft_delete/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )

    def rest_update_picture(
        self, auth_token, picture_pk, project_pks, title, background_img_file_name, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for updateing a picture via REST API"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)

        # open background image and post it to the rest api
        fp = open(os.path.join(os.path.dirname(__file__), "demo_pictures", background_img_file_name), "rb")

        data = {"title": title, "background_image": fp}
    ...
    def rest_update_picture_shape_file(self, auth_token, picture_pk, shape_file_name, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        # open background image and post it to the rest api
        fp = open(os.path.join(os.path.dirname(__file__), "demo_pictures", shape_file_name), "rb")

        data = {"shapes_image": fp}
    ...
    def rest_update_picture_background_image_file(
        self, auth_token, picture_pk, background_image_file_name, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
        ...
        # open background image and post it to the rest api
        fp = open(os.path.join(os.path.dirname(__file__), "demo_pictures", background_image_file_name), "rb")

        data = {"background_image": fp}
    ...
    def rest_update_picture_rendered_image_file(
        self, auth_token, picture_pk, rendered_image_file_name, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
        ...
        # open background image and post it to the rest api
        fp = open(os.path.join(os.path.dirname(__file__), "demo_pictures", rendered_image_file_name), "rb")

        data = {"rendered_image": fp}
    ...
    def rest_create_picture(
        self, auth_token, project_pks, title, background_img_file_name, HTTP_USER_AGENT, REMOTE_ADDR
    ):
    ...
    def create_picture_orm(self, auth_token, project_pk, title, background_img_file_name, HTTP_USER_AGENT, REMOTE_ADDR):
        """Wrapper for rest_create_picture which also returns a Picture Object from Djangos ORM"""

        response = self.rest_create_picture(
            auth_token, project_pk, title, background_img_file_name, HTTP_USER_AGENT, REMOTE_ADDR
        )
