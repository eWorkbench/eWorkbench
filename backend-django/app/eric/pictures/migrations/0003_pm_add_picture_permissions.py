...
class Migration(migrations.Migration):
    permissions_to_add = [
        # codename, app, model
        # pictures
        ['restore_picture', 'pictures', 'picture'],
        ['trash_picture', 'pictures', 'picture'],
        ['view_picture', 'pictures', 'picture'],
        ['add_picture', 'pictures', 'picture'],
        ['change_picture', 'pictures', 'picture'],
        ['delete_picture', 'pictures', 'picture'],
        ['change_project_picture', 'pictures', 'picture']
    ]

    dependencies = [
        ('pictures', '0002_add_create_without_project_permission_to_user_group'),
    ]
