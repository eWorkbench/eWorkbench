...
def validate_file_is_json(value):
    ...
    try:
        value.file.seek(0)
        json.loads(value.file.read().decode("utf-8"))
    except Exception:
...
class Picture(
    ...
    title = models.CharField(max_length=128, verbose_name=_("Title of the picture"))

    width = models.IntegerField(default=512, verbose_name=_("Width of the picture in pixel"))

    height = models.IntegerField(default=512, verbose_name=_("Height of the picture in pixel"))
    ...
    rendered_image_size = models.BigIntegerField(verbose_name=_("Size of the rendered image"), default=0)
    ...
    shapes_image_size = models.BigIntegerField(verbose_name=_("Size of the background image"), default=0)
    ...
    def store_image_file(self, image):
        ...
        new_path = settings.WORKBENCH_SETTINGS["project_file_upload_folder"] % {"filename": new_name}
