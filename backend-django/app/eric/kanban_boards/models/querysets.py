...
class KanbanBoardQuerySet(BaseProjectEntityPermissionQuerySet, ChangeSetQuerySetMixin):
    ...
    def prefetch_common(self, *args, **kwargs):
        return super().prefetch_common().with_columns()
...
class KanbanBoardUserFilterSettingQuerySet(BaseQuerySet):
    ...
    def viewable(self, *args, **kwargs):
        ...
        return self.filter(
            user=get_current_user(), kanban_board__pk__in=KanbanBoard.objects.viewable().values_list("pk")
        )
    ...
    def editable(self, *args, **kwargs):
        ...
        return self.filter(
            user=get_current_user(), kanban_board__pk__in=KanbanBoard.objects.editable().values_list("pk")
        )
    ...
    def deletable(self, *args, **kwargs):
        ...
        return self.filter(
            user=get_current_user(), kanban_board__pk__in=KanbanBoard.objects.deletable().values_list("pk")
        )
