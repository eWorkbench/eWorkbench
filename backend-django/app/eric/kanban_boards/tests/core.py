...
class KanbanBoardMixin:
    ...
    def rest_get_kanbanboard_export_link(self, auth_token, kanban_board_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/kanbanboards/{kanban_board_pk}/get_export_link/",
    ...
    def rest_search_kanbanboards(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/kanbanboards/?search={search_string}",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_kanbanboards_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/kanbanboards/?recently_modified_by_me={number_of_days}",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_kanbanboard(self, auth_token, kanban_board_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/kanbanboards/{kanban_board_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_kanbanboards(self, auth_token, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get("/api/kanbanboards/", {}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_kanbanboards_for_project(self, auth_token, project_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            "/api/kanbanboards/", {"project": project_pk}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_kanbanboard(self, auth_token, kanban_board_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            f"/api/kanbanboards/{kanban_board_pk}/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_restore_kanbanboard(self, auth_token, kanban_board_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/kanbanboards/{kanban_board_pk}/restore/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_trash_kanbanboard(self, auth_token, kanban_board_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/kanbanboards/{kanban_board_pk}/soft_delete/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )

    def rest_update_kanbanboard(
        self, auth_token, kanban_board_pk, project_pks, title, HTTP_USER_AGENT, REMOTE_ADDR, kanban_board_columns=None
    ):
    ...
    def rest_update_kanbanboard_child_elements(
        self, auth_token, kanban_board_pk, kanban_board_columns, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
    ...
    def rest_create_kanbanboard(
        self, auth_token, project_pks, title, HTTP_USER_AGENT, REMOTE_ADDR, kanban_board_columns=None
    ):
    ...
    def rest_get_tasks_of_kanbanboard(self, auth_token, kanban_board_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        """Wrapper for adding a task into a kanban board column"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)

        return self.client.get(
            f"/api/kanbanboards/{kanban_board_pk}/tasks/",
            content_type="application/json",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_kanbanboards_and_columns_of_task(self, auth_token, task_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/tasks/{task_pk}/kanbanboard_assignments/",
            content_type="application/json",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )

    def rest_add_task_to_kanbanboard_column(
        self, auth_token, kanban_board_pk, kanban_board_column_pk, task_pk, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for adding a task into a kanban board column"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)
    ...
    def rest_add_tasks_to_kanbanboard_column(self, auth_token, kanban_board_pk, data, HTTP_USER_AGENT, REMOTE_ADDR):
        """Wrapper for adding more than one task into a kanban board column"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)

        return self.client.post(
            f"/api/kanbanboards/{kanban_board_pk}/tasks/create_many/",
            json.dumps(data, default=custom_json_handler),
            content_type="application/json",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
    ...
    def rest_move_tasks_between_kanbanboard_columns(
        self, auth_token, kanban_board_pk, data, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for adding more than one task into a kanban board column"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)

        return self.client.put(
            f"/api/kanbanboards/{kanban_board_pk}/tasks/move_assignment/",
            json.dumps(data, default=custom_json_handler),
            content_type="application/json",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
    ...
    def rest_delete_task_from_kanbanboard(
        self, auth_token, kanban_board_pk, task_assignment_pk, HTTP_USER_AGENT, REMOTE_ADDR
    ):
...
class KanbanBoardClient:
    ...
    def update_background_image(self, pk, image_bytes, content_type="image/jpeg"):
        ...
        response = self.client.patch(
            path=f"/api/kanbanboards/{pk}/",
            data={"background_image": SimpleUploadedFile("test.jpg", image_bytes, content_type=content_type)},
            HTTP_USER_AGENT=self.http_user_agent,
            REMOTE_ADDR=self.remote_address,
        )
