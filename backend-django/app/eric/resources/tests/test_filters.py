...
class ResourceFiltersTest(APITestCase, CommonTestMixin, ResourceMixin):
    ...
    def test_query_without_filters(self):
        ...
        self.create_study_room_for_resource(self.resource1, branch_library=StudyRoom.MAIN_CAMPUS)
    ...
    def test_filter_combination(self):
        ...
        self.create_study_room_for_resource(
            self.resource3,
            branch_library=StudyRoom.CHEMISTRY,
            is_bookable_by_students=False,
        )
    ...
    def assert_resulting_resources(self, response, expected_resources):
        ...
        actual_names = {resource["name"] for resource in json_response["results"]}
