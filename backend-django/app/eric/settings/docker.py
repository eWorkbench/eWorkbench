...
#
from django_auth_ldap.config import GroupOfNamesType, LDAPSearch, PosixGroupType
...
AUTH_LDAP_USER_ASSIGN_GROUP_BASED_ON_ATTRIBUTE = {
    "o": [{"value_regex": "^employee$", "group_name": "User"}, {"value_regex": "^external$", "group_name": "External"}]
}
...
DATA_UPLOAD_MAX_MEMORY_SIZE = None  # !!! DO NOT DO THIS IN PRODUCTION
