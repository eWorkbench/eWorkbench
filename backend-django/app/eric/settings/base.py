...
INSTALLED_APPS = (
    ...
    # cache backend that allows caching with decorators
    # 'memoize',
)
...
LOGGING = {
    ...
    'loggers': {
        ...
        'js_errors': {
            'handlers': ['js_errors', 'console', ],
            'level': 'DEBUG',
            'propagate': True
        },
        # urllib3 is very verbose...
        ...
        #     'formatter': 'verbose'
        # },
        # disable logging for django user foreign key
        'django_userforeignkey': {
            'handlers': [],
            'propagate': False
        },
        'eric.model_privileges.handlers': {
            'handlers': ['file', 'console', ],
            'level': 'DEBUG',
            'propagate': True,
            'formatter': 'verbose'
        },
        'eric.projects.models.handlers': {
            'handlers': ['file', 'console', ],
            'level': 'DEBUG',
            'propagate': True,
            'formatter': 'verbose'
        },
        'eric.userprofile.models.handlers': {
            'handlers': ['file', 'console', ],
            'level': 'DEBUG',
            'propagate': True,
            'formatter': 'verbose'
        },
        'eric.shared_elements.models.handlers': {
            'handlers': ['file', 'console', ],
            'level': 'DEBUG',
            'propagate': True,
            'formatter': 'verbose'
...
NOTIFICATIONS_TIME_BETWEEN_EMAILS = 5 * 60
...
WORKBENCH_SETTINGS = {
    'url': 'http://workbench.dev/',
    'password_reset_url': 'http://workbench.dev/#/password_reset/{token}',
