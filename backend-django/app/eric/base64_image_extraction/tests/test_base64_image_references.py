...
from eric.core.utils import (
    convert_base64_image_strings_to_file_references,
...
class Base64ImageReferencesTestCase(TestCase):
    def setUp(self):
        ...
        self.base64_string = (
            "iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAIAAABMXPacAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAA"
        ...
        self.full_base64_string = f"data:image/png;base64,{self.base64_string}"
        self.base64_image_tag = '<img src="{}" alt="Test_image.png" title="Test_image.png">'.format(
            self.full_base64_string
        )
        self.base64_image_tag_incomplete = f'<img src="{self.full_base64_string}">'
    ...
    def test_decode_base64_with_padding_correction(self):
        ...
        self.assertNotEqual(invalid_base64_string, valid_base64_string)
    ...
    def test_guess_extension_for_file(self):
        ...
        file_extension = guess_extension_for_file(
            decode_base64_with_padding_correction(self.base64_ascii_string), self.image_attributes["mime_type"]
        )
