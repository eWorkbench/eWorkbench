...
class ExtractedImage(BaseModel):
    ...
    source_field = models.CharField(max_length=128, verbose_name=_("Model field the image was extracted from"))

    created_at = models.DateTimeField(auto_now=True)

    created_by = UserForeignKey(
        auto_user_add=True, verbose_name=_("Who extracted this element"), related_name="extracted_images"
    )
