...
class SortableMenuTest(APITestCase, AuthenticationMixin, MenuEntryMixin):
    ...
    def test_list_menu_entries(self):
        ...
        self.assertEqual(len(decoded_response), cnt_default_menu_entries)
    ...
    def test_update_menu_entry_order(self):
        ...
        # verify ordering
        self.assertEqual(MenuEntry.objects.get(pk=menu_entries[0]["pk"]).ordering, new_ordering_for_0)
        self.assertEqual(MenuEntry.objects.get(pk=menu_entries[2]["pk"]).ordering, new_ordering_for_2)
