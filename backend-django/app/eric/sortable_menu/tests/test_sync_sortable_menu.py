...
class SyncSortableMenuTest(APITestCase, AuthenticationMixin):
    ...
    def test_command_with_users(self):
        user1 = User.objects.create_user(username='student_1', email='student_1@email.com', password='top_secret')
        ...
        self.assertNotEquals(num_entries, 0)
        ...
        self.assertEquals(MenuEntry.objects.all().count(), 1)
