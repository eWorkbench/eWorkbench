...
class LabBookMixin:
    ...
    def rest_get_labbook_export_link(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/labbooks/{labbook_pk}/get_export_link/",
    ...
    def rest_search_labbooks(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/labbooks/?search={search_string}", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_labbooks_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/labbooks/?recently_modified_by_me={number_of_days}",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_labbook(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(f"/api/labbooks/{labbook_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_labbooks(self, auth_token, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get("/api/labbooks/", {}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_labbook_elements(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/labbooks/{labbook_pk}/elements/",
            {},
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_labbook_elements_for_section(self, auth_token, labbook_pk, section_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            "/api/labbooks/{labbook_pk}/elements/?section={section_pk}".format(
                labbook_pk=labbook_pk, section_pk=section_pk
            ),
            {},
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
    ...
    def rest_remove_labbook_element(self, auth_token, labbook_pk, element_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            f"/api/labbooks/{labbook_pk}/elements/{element_pk}/",
            None,
            content_type="application/json",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
    ...
    def rest_get_labbooks_for_project(self, auth_token, project_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            "/api/labbooks/", {"project": project_pk}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_labbook(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(
            f"/api/labbooks/{labbook_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_restore_labbook(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/labbooks/{labbook_pk}/restore/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_trash_labbook(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/labbooks/{labbook_pk}/soft_delete/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )

    def rest_update_labbook(
        self, auth_token, labbook_pk, project_pks, title, is_template, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for updateing a labbook via REST API"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)

        data = {"title": title, "is_template": is_template}
    ...
    def rest_unlock_labbook(self, auth_token, labbook_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.post(
            f"/api/labbooks/{labbook_pk}/unlock/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_create_labbook(self, auth_token, project_pks, title, is_template, HTTP_USER_AGENT, REMOTE_ADDR):
    ...
    def create_labbook_orm(self, auth_token, project_pk, title, is_template, HTTP_USER_AGENT, REMOTE_ADDR):
        """Wrapper for rest_create_labbook which also returns a LabBook Object from Djangos ORM"""

        response = self.rest_create_labbook(auth_token, project_pk, title, is_template, HTTP_USER_AGENT, REMOTE_ADDR)
...
class LabbookSectionMixin(TestLockMixin):
    ...
    def rest_get_labbooksection(self, auth_token, labbooksection_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/labbooksections/{labbooksection_pk}/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_labbooksections(self, auth_token, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get("/api/labbooksections/", {}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_restore_labbooksection(self, auth_token, labbooksection_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/labbooksections/{labbooksection_pk}/restore/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_trash_labbooksection(self, auth_token, labbooksection_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/labbooksections/{labbooksection_pk}/soft_delete/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )

    def rest_update_labbooksection(
        self, auth_token, labbooksection_pk, project_pks, date, title, child_elements, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for creating a file via REST API"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)
    ...
    def rest_update_labbooksection_project(
        self, auth_token, labbooksection_pk, project_pks, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
    ...
    def rest_create_labbooksection(
        self, auth_token, project_pks, date, title, child_elements, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for creating a file via REST API"""
        self.client.credentials(HTTP_AUTHORIZATION="Token " + auth_token)
    ...
    def create_labbooksection_orm(
        self, auth_token, project_pk, date, title, child_elements, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for rest_create_labbooksection which also returns a Task Object from Djangos ORM"""

        response = self.rest_create_labbooksection(
            auth_token, project_pk, date, title, child_elements, HTTP_USER_AGENT, REMOTE_ADDR
        )
        if response.status_code == status.HTTP_201_CREATED:
            decoded = json.loads(response.content.decode())
