...
class DriveMixin:
    ...
    def rest_get_drive_export_link(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/drives/{drive_pk}/get_export_link/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_search_drives(self, auth_token, search_string, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/drives/?search={search_string}", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_get_drives_recently_modified_by_me(self, auth_token, number_of_days, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/drives/?recently_modified_by_me={number_of_days}",
    ...
    def rest_get_drive(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(f"/api/drives/{drive_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_drives(self, auth_token, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get("/api/drives/", {}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_get_drive_elements(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/drives/{drive_pk}/elements/",
            {},
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_get_drives_for_project(self, auth_token, project_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            "/api/drives/", {"project": project_pk}, HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_delete_drive(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.delete(f"/api/drives/{drive_pk}/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR)
    ...
    def rest_restore_drive(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/drives/{drive_pk}/restore/", HTTP_USER_AGENT=HTTP_USER_AGENT, REMOTE_ADDR=REMOTE_ADDR
        )
    ...
    def rest_trash_drive(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.patch(
            f"/api/drives/{drive_pk}/soft_delete/",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
        )
    ...
    def rest_drive_get_directories(self, auth_token, drive_pk, HTTP_USER_AGENT, REMOTE_ADDR):
        ...
        return self.client.get(
            f"/api/drives/{drive_pk}/sub_directories/",
            None,
            content_type="application/json",
            HTTP_USER_AGENT=HTTP_USER_AGENT,
            REMOTE_ADDR=REMOTE_ADDR,
    ...
    def rest_drive_create_directory(
        self, auth_token, drive_pk, name, parent_directory_pk, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
    ...
    def rest_drive_create_dss_directory(
        self, auth_token, drive_pk, name, parent_directory_pk, imported, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
        Wrapper for creating a directory within a drive
        """
    ...
    def rest_drive_update_directory(
        self, auth_token, drive_pk, directory_pk, name, parent_directory_pk, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """
    ...
    def rest_create_drive(self, auth_token, project_pks, title, HTTP_USER_AGENT, REMOTE_ADDR):
    ...
    def create_drive_orm(self, auth_token, project_pk, title, HTTP_USER_AGENT, REMOTE_ADDR):
        """Wrapper for rest_create_drive which also returns a Drive Object from Djangos ORM"""

        response = self.rest_create_drive(auth_token, project_pk, title, HTTP_USER_AGENT, REMOTE_ADDR)
    ...
    def rest_create_dss_drive(
        self, auth_token, project_pks, title, dss_envelope_id, imported, HTTP_USER_AGENT, REMOTE_ADDR
    ):
    ...
    def create_dss_drive_orm(
        self, auth_token, project_pk, title, dss_envelope_id, imported, HTTP_USER_AGENT, REMOTE_ADDR
    ):
        """Wrapper for rest_create_dss_drive which also returns a Drive Object from Djangos ORM"""

        response = self.rest_create_dss_drive(
            auth_token, project_pk, title, dss_envelope_id, imported, HTTP_USER_AGENT, REMOTE_ADDR
        )
        if response.status_code == status.HTTP_201_CREATED:
            decoded = json.loads(response.content.decode())
            return Drive.objects.get(pk=decoded["pk"]), response
    ...
    def rest_update_dss_drive(
        self, auth_token, drive_pk, project_pks, title, dss_envelope_id, imported, HTTP_USER_AGENT, REMOTE_ADDR
    ):
