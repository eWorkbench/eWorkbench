...
class UserProfile(BaseModel):
    ...
    NORMAL_USER = "u"
    LDAP_USER = "l"
    USER_TYPE_CHOICES = ((NORMAL_USER, "Normal User"), (LDAP_USER, "LDAP User"))
    ...
    anonymized = models.BooleanField(default=False, verbose_name=_("Anonymized User"))
    academic_title = models.CharField(max_length=128, verbose_name=_("Academic title of the user"), blank=True)
    additional_information = models.TextField(verbose_name=_("Additional information about the user"), blank=True)
    country = models.CharField(max_length=128, verbose_name=_("Country of the user"), blank=True)
    ...
    phone = models.CharField(max_length=128, verbose_name=_("Phone number of the user"), blank=True)
    salutation = models.CharField(max_length=128, verbose_name=_("Salutation of the user"), blank=True)
    title_salutation = models.CharField(max_length=128, verbose_name=_("Salutation title of the user"), blank=True)
    title_pre = models.CharField(max_length=128, verbose_name=_("Pre title of the user"), blank=True)
    title_post = models.CharField(max_length=128, verbose_name=_("Post title of the user"), blank=True)
    type = models.CharField(
        max_length=5, choices=USER_TYPE_CHOICES, default=NORMAL_USER, verbose_name=_("Type of the user object")
    )
    ...
    website = models.URLField(verbose_name=_("URL of the User"), null=True, blank=True)

    jwt_verification_token = models.CharField(max_length=128, verbose_name=_("Verification Token for JWT"), default="")
    ...
    affiliation_prim = models.CharField(
        max_length=20,
        choices=AFFILIATION_PRIM,
        default=MEMBER,
        verbose_name=_("Affiliation prim of the user"),
    )

    alum_timestamp = models.DateTimeField(
        verbose_name=_("Date when the users affiliation prim was set to alum"),
        null=True,
        blank=True,
        db_index=True,
    )
    ...
    inactivated_at = models.DateTimeField(
        verbose_name=_("Date since when the user is inactive"),
        null=True,
        blank=True,
        db_index=True,
    )

    date_anonymized = models.DateTimeField(
        verbose_name=_("Date when this user was anonymized"),
        default=None,
        null=True,
        blank=True,
    )
    ...
    date_invited = models.DateTimeField(
        verbose_name=_("Date when this user was invited"),
        default=None,
        null=True,
        blank=True,
    )
    ...
    def status(self):
        ...
        if not self.user.last_login and self.date_invited:
