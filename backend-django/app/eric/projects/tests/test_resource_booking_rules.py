...
class ResourceBookingsTest(APITestCase, AuthenticationMixin, UserMixin, ResourceMixin, ResourceBookingMixin):
    ...
    def test_resourcebooking_validate_booking_rule_minimum_duration(self):
        booking_rule_minimum_duration = ResourceBookingRuleMinimumDuration.objects.create(
            duration="01:00:00",
    ...
    def test_resourcebooking_validate_booking_rule_maximum_duration(self):
        booking_rule_maximum_duration = ResourceBookingRuleMaximumDuration.objects.create(
            duration="01:00:00",
            resource=self.resource1,
        )
    ...
    def test_resourcebooking_validate_booking_rule_bookable_hours(self):
        booking_rule_bookable_hours = ResourceBookingRuleBookableHours.objects.create(
            monday=True,
            tuesday=False,
            wednesday=True,
            thursday=True,
    ...
    def test_resourcebooking_validate_booking_rule_minimum_time_before(self):
        booking_rule_minimum_time_before = ResourceBookingRuleMinimumTimeBefore.objects.create(
            duration="01:00:00",
            resource=self.resource1,
        )
    ...
    def test_resourcebooking_validate_booking_rule_maximum_time_before(self):
        booking_rule_maximum_time_before = ResourceBookingRuleMaximumTimeBefore.objects.create(
    ...
    def test_resourcebooking_validate_booking_rule_time_between(self):
        booking_rule_time_between = ResourceBookingRuleTimeBetween.objects.create(
            duration="02:00:00",
            resource=self.resource1,
        )
    ...
    def test_resourcebooking_validate_booking_rule_bookings_per_user(self):
        booking_rule_bookings_per_user = ResourceBookingRuleBookingsPerUser.objects.create(
            count=2,
            unit='DAY',
            resource=self.resource1,
        )

        booking_rule_bookings_per_user2 = ResourceBookingRuleBookingsPerUser.objects.create(
            count=3,
            unit='WEEK',
            resource=self.resource1,
        )

        booking_rule_bookings_per_user3 = ResourceBookingRuleBookingsPerUser.objects.create(
            count=4,
            unit='MONTH',
            resource=self.resource1,
        )
       ...
       # set another booking up for another day within this week
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEquals(ResourceBooking.objects.all().count(), 3, msg="There should be three resourcebookings")
       ...
       # set a 2nd booking up for another day within the month 2 months from now
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEquals(ResourceBooking.objects.all().count(), 5, msg="There should be four resourcebookings")
       ...
       # set a 3rd booking up for another day within the month 2 months from now
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEquals(ResourceBooking.objects.all().count(), 6, msg="There should be four resourcebookings")
       ...
       # set a 4th and last booking up for another day within the month 2 months from now
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEquals(ResourceBooking.objects.all().count(), 7, msg="There should be four resourcebookings")
