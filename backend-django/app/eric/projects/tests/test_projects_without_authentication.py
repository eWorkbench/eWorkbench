...
class ProjectsWithoutAuthTest(APITestCase, AuthenticationMixin, ProjectsMixin):
    ...
    def setUp(self):
        ...
        self.assertEqual(Project.objects.all().count(), 1, msg="There should be one project in the database")
    ...
    def test_create_without_auth(self):
        ...
        self.assertEqual(
            ...
            old_project_count,
            msg="There should be no additional projects in the database",
        )
