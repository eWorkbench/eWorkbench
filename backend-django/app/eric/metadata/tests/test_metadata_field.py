...
class MetadataFieldAPITest(
    ...
    def test_post_and_get_list(self):
        ...
        self.request_builder.post(api_data("MyFraction", "x/y", MetadataField.BASE_TYPE_FRACTION, {}))
        self.request_builder.post(api_data("MyDecimal", "x.y", MetadataField.BASE_TYPE_DECIMAL_NUMBER, {"decimals": 3}))
    ...
    def test_invalid_base_type(self):
        self.request_builder.post(api_data("MyNewField", "Description", -123, {}), assert_status=HTTP_400_BAD_REQUEST)
    ...
    def test_post_new_metadata_without_add_permission(self):
        ...
        response = self.request_builder.post(
            api_data("MyGPS", "GPS data", MetadataField.BASE_TYPE_GPS, {}), assert_status=HTTP_200_OK
        )
        json_response = json.loads(response.content.decode())
