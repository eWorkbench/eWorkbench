...
class SearchTestMixin(AuthenticationMixin, ModelPrivilegeMixin, HelperMixin, ProjectsMixin, NoteMixin):
    ...
    def patch_metadata(self, entity, metadata, endpoint="notes"):
        response = self.client.patch(
            path=f"/api/{endpoint}/{entity.pk}/",
            data=json.dumps({"metadata": metadata}, default=custom_json_handler),
    ...
    def assert_result_list(self, json_response, expected_result_list):
        ...
        for entity in expected_result_list:
            self.assertTrue(str(entity.pk) in result_pks, f"{str(entity)} missing")
...
class SelectionSearchTest(SearchTestMixin, APITestCase):
    def test_simple_search(self):
        self.patch_metadata(
            ...
            [
                {
                    "field": self.selection_field.pk,
                    "values": {
                        "answers": [
                            {"answer": "Check Point 2", "selected": True},
                ...
                {
                    "field": self.selection_field.pk,
                    "values": {"single_selected": "Check Point 4", "custom_input": "test text"},
                    "parameter_index": "0",
                },
            ],
        )
                ...
                [
                    {
                        "field": self.selection_field.pk,
                        "operator": "=",
                        "values": {"single_selected": "Check Point 2"},
                        "parameter_index": "0",
                    },
                ]
            ]
                ...
                [
                    {
                        "field": self.selection_field.pk,
                        "operator": "=",
                        "values": {"single_selected": "Check Point 4", "custom_input": "other test text"},
                        "parameter_index": "0",
                    },
                ]
            ]
    ...
    def test_simple_search(self):
        ...
        json_response = self.send_search_request(
            [
                [
                    {
                        "field": self.gps_field.pk,
                        "operator": "=",
                        "values": {"x": "mno", "y": "pqrst"},
                        "parameter_index": "0",
                    },
                ]
            ]
    ...
    def test_simple_search(self):
        ...
        json_response = self.send_search_request(
            [
                [
                    {
                        "field": self.decimal_number_field.pk,
                        "operator": "=",
                        "values": {"value": 5.321},
                        "parameter_index": "0",
                    },
    ...
    def test_simple_search(self):
        ...
        json_response = self.send_search_request(
            [
                [
                    {
                        "field": self.time_field.pk,
                        "operator": "=",
                        "values": {"value": 10 * 60 + 35},
                        "parameter_index": "0",
                    },
                ]
            ]
...
class DateSearchTest(SearchTestMixin, APITestCase):
    def test_simple_search(self):
        self.patch_metadata(
            ...
            [
                {
                    "field": self.date_field.pk,
                    "values": {"value": parse_datetime("2018-01-01 01:01").isoformat()},
                    "parameter_index": "0",
                },
            ],
        )
        self.patch_metadata(
            ...
            [
                {
                    "field": self.date_field.pk,
                    "values": {"value": parse_datetime("2018-01-01 01:00").isoformat()},
                    "parameter_index": "1",
                },
            ],
        )
        self.patch_metadata(
            ...
            [
                {
                    "field": self.date_field.pk,
                    "values": {"value": parse_datetime("2027-04-17 23:59").isoformat()},
                    "parameter_index": "2",
                },
            ],
        )
                ...
                [
                    {
                        "field": self.date_field.pk,
                        "operator": "=",
                        "values": {"value": parse_datetime("2018-01-01 01:01")},
                        "parameter_index": "0",
                    },
                ]
            ]
                ...
                [
                    {
                        "field": self.date_field.pk,
                        "operator": ">",
                        "values": {"value": parse_datetime("2018-01-01 01:00")},
                        "parameter_index": "0",
                    },
                ]
            ]
                ...
                [
                    {
                        "field": self.date_field.pk,
                        "operator": "<",
                        "values": {"value": parse_datetime("2027-04-17 23:59")},
                        "parameter_index": "0",
                    },
                ]
            ]
...
class RealDateSearchTest(SearchTestMixin, APITestCase):
    def test_simple_search(self):
        self.patch_metadata(
            ...
            [
                {
                    "field": self.real_date_field.pk,
                    "values": {"value": parse_date("2018-01-01")},
                    "parameter_index": "0",
                },
            ],
        )
        self.patch_metadata(
            ...
            [
                {
                    "field": self.real_date_field.pk,
                    "values": {"value": parse_date("2018-01-02")},
                    "parameter_index": "1",
                },
            ],
        )
        self.patch_metadata(
            ...
            [
                {
                    "field": self.real_date_field.pk,
                    "values": {"value": parse_date("2027-04-17")},
                    "parameter_index": "2",
                },
            ],
        )
...
class FractionSearchTest(SearchTestMixin, APITestCase):
    def test_simple_search(self):
        self.patch_metadata(
            ...
            [
                {
                    "field": self.fraction_field.pk,
                    "values": {"numerator": 4, "denominator": 789},
                    "parameter_index": "0",
                },
            ],
        )
        self.patch_metadata(
            ...
            [
                {
                    "field": self.fraction_field.pk,
                    "values": {"numerator": 3, "denominator": 789},
                    "parameter_index": "1",
                },
            ],
        )
        self.patch_metadata(
            ...
            [
                {
                    "field": self.fraction_field.pk,
                    "values": {"numerator": 321, "denominator": 1},
                    "parameter_index": "2",
                },
            ],
        )
                ...
                [
                    {
                        "field": self.fraction_field.pk,
                        "operator": ">",
                        "values": {"numerator": 0, "denominator": 0},
                        "parameter_index": "0",
                    },
                ]
            ],
                ...
                [
                    {
                        "field": self.fraction_field.pk,
                        "operator": ">=",
                        "values": {"numerator": 0, "denominator": 1},
                        "parameter_index": "0",
                    },
                ]
            ]
...
class InvalidFieldSearchTest(SearchTestMixin, APITestCase):
    def test_search_with_invalid_field(self):
        self.send_search_request(
            [
                [
                    {"field": self.note1.pk, "operator": "=", "values": {"value": 123}, "parameter_index": "0"},
                ]
            ],
            expected_status_code=HTTP_400_BAD_REQUEST,
        )
    ...
    def test_multiple_and_parameters(self):
        ...
        self.patch_metadata(
            ...
            [
                {
                    "field": self.date_field.pk,
                    "values": {"value": parse_datetime("2018-12-12 12:12")},
                    "parameter_index": "0",
                },
                {"field": self.text_field.pk, "values": {"value": "HOLA! SOY YO!"}, "parameter_index": "0"},
                {"field": self.whole_number_field.pk, "values": {"value": 23}, "parameter_index": "0"},
            ...
            [
                [
                    ...
                    },
                    {
                        "field": self.date_field.pk,
                        "operator": "<",
                        "values": {"value": parse_datetime("2018-02-02 22:22")},
                        "parameter_index": "0",
                    },
                    {
                        "field": self.whole_number_field.pk,
...
class MetadataSearchIntegrationTest(
    ...
    def test_contact(self):
        contact, response = self.create_contact_orm(
            self.token, self.project.pk, "Dr.", "Max", "Mustermann", "max@muster.om", **http_info
        )
        self.assert_entity_can_be_found(contact, "contacts")

    def test_labbook(self):
        labbook, response = self.create_labbook_orm(self.token, self.project.pk, "MyLabBook", False, **http_info)
    ...
    def test_picture(self):
        picture, response = self.create_picture_orm(self.token, self.project.pk, "MyPicture", "demo1.png", *http_info)
        self.assert_entity_can_be_found(picture, "pictures")

    def test_file(self):
        file, response = self.create_file_orm(
            self.token, self.project.pk, "MyFile", "MyFileDescription", "demo1.txt", 1024, **http_info
        )
    ...
    def test_dmp(self):
        ...
        dmp, response = self.create_dmp_orm(self.token, self.project.pk, "MyDMP", Dmp.FINAL, dmp_form.pk, **http_info)
    ...
    def assert_entity_can_be_found(self, entity, endpoint):
        ...
        self.patch_metadata(
            entity=entity,
            metadata=[
                {"field": self.whole_number_field.pk, "values": {"value": metadata_value}, "parameter_index": "0"}
            ],
            endpoint=endpoint,
        )
...
class ModelFilterTest(
    ...
    def search_for_content_type(self, content_type):
        return self.send_search_request(
            [[{"field": self.whole_number_field.pk, "operator": "=", "values": {"value": 1}, "parameter_index": "0"}]],
            content_type=content_type,
        )
    ...
    def create_entities_with_metadata(self):
        ...
        self.labbook, response = self.create_labbook_orm(self.token, self.project.pk, "MyLabBook", False, **http_info)
        ...
        self.picture, response = self.create_picture_orm(
            self.token, self.project.pk, "MyPicture", "demo1.png", *http_info
        )
        ...
        self.dmp, response = self.create_dmp_orm(
            self.token, self.project.pk, "MyDMP", Dmp.FINAL, dmp_form.pk, **http_info
        )
...
class ViewableFilterTest(SearchTestMixin, APITestCase):
                ...
                [
                    {
                        "field": self.whole_number_field.pk,
                        "operator": "=",
                        "values": {"value": self.metadata_value},
                        "parameter_index": "0",
                    },
                ]
            ]
    ...
    def test_superuser_finds_all_entities(self):
        ...
        self.assert_result_list(json_response, [self.user1_note, self.user2_note, self.user3_note])
